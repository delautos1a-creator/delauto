...
function signInWith(provider: "google" | "azure" | "apple") {
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="space-y-2.5 mb-5">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-2.5 rounded-xl border border-border bg-secondary hover:bg-secondary/80 transition-colors text-sm font-semibold text-foreground"
          >
            <GoogleIcon />
        ...
        <div className="flex items-center gap-3 mb-5">
          ...
          <span className="text-xs text-muted-foreground">ili emailom</span>
          <div className="flex-1 h-px bg-border" />
        </div>
