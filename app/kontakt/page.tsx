      ...
      <main className="min-h-screen bg-background">
        ...
        <div className="bg-navy text-white py-14 px-4 text-center">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-white/55">
              Naš tim je spreman pomoći vam pronaći savršeno vozilo.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto px-4 py-14">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            {/* Left — Info card (dark navy) */}
            <div className="bg-navy text-white rounded-2xl p-8 flex flex-col gap-6">
              <div>
                <h2 className="text-xl font-black mb-1">Informacije o salonu</h2>
              ...
              <div className="space-y-5">
                <div className="flex gap-4">
                  ...
                  <div>
                    <p className="text-xs text-white/40 uppercase tracking-wider mb-0.5">Adresa</p>
                    <p className="text-sm font-medium">Džemala Bijedića 168</p>
                    <p className="text-sm text-white/60">Sarajevo 71000, BiH</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+38761199645" className="text-sm font-medium hover:text-primary transition-colors">
                      +387 61 199 645
                    </a>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@delauto.ba" className="text-sm font-medium hover:text-primary transition-colors">
                      info@delauto.ba
                    </a>
                  </div>
                </div>
              ...
              <div>
                ...
                <div className="flex gap-2.5">
                  <a
                    ...
                    className="w-10 h-10 rounded-full bg-white/10 hover:bg-primary hover:text-primary-foreground flex items-center justify-center transition-colors"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-10 h-10 rounded-full bg-white/10 hover:bg-primary hover:text-primary-foreground flex items-center justify-center transition-colors text-white font-black text-[11px] tracking-tight"
                    aria-label="OLX"
                  >
                    OLX
                  </a>
